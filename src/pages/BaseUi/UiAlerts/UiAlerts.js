...
const UiAlerts = () => {
  document.title = "Alerts | Eezer - React Admin & Dashboard Template";
                  ...
                  <div className="live-preview">
                    <Row>
                      <Col xl={6}>
                        ...
                        <UncontrolledAlert
                          color="primary"
                          className="alert-primary alert-dismissible bg-primary text-white alert-label-icon fade show"
                        ...
                        <UncontrolledAlert
                          color="secondary"
                          className="alert-secondary alert-dismissible bg-secondary text-white alert-label-icon fade show"
                          closeClassName="btn-close-white"
                        >
                        ...
                        <UncontrolledAlert
                          color="success"
                          className=" alert-success alert-dismissible bg-success text-white alert-label-icon fade show"
                          closeClassName="btn-close-white"
                        >
                        ...
                        <UncontrolledAlert
                          color="danger"
                          className=" alert-danger alert-dismissible bg-danger text-white alert-label-icon fade show mb-xl-0"
                          closeClassName="btn-close-white"
                        >
                      ...
                      <Col xl={6}>
                        ...
                        <UncontrolledAlert
                          color="warning"
                          className=" alert-warning alert-dismissible bg-warning text-white alert-label-icon fade show"
                          closeClassName="btn-close-white"
                        >
                        ...
                        <UncontrolledAlert
                          color="info"
                          className=" alert-info alert-dismissible bg-info text-white alert-label-icon fade show"
                          closeClassName="btn-close-white"
                        >
                        ...
                        <UncontrolledAlert
                          color="light"
                          className=" alert-light alert-dismissible bg-light text-body alert-label-icon fade show"
                          closeClassName="btn-close-white"
                        >
                        ...
                        <UncontrolledAlert
                          color="dark"
                          className=" alert-dark alert-dismissible bg-dark text-white alert-label-icon fade show mb-0"
                          closeClassName="btn-close-white"
                        >
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the class to set an alert with solid style.
                  </p>
