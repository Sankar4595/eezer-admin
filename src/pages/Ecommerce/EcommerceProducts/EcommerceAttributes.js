...
const EcommerceAttributes = (props) => {
  ...
  const ecomAttributeProperties = createSelector(selectLayoutState, (ecom) => ({
    Attribute: ecom.Attribute,
    error: ecom.error,
  }));
  // Inside your component
  const { Attribute, error } = useSelector(ecomAttributeProperties);
  ...
  const addAttribute = async () => {
    ...
    await dispatch(onAddNewAttribute(newAttribute));
  ...
  const AttributeOptions = Object.values(Attribute).map((row) => ({
    label: row.name,
    value: row._id,
    data: row.attributes,
  }));
            ...
            <CardBody>
              <div id="customerList">
                <Row className="g-4 mb-3">
                  <Col style={{ width: "100%" }} className="col-sm-auto">
                    <div style={{ width: "100%" }}>
                      <div
                  ...
                  >
                    <thead className="table-light">
                      <tr>
                        ...
                        <th className="sort" data-sort="Attribute_name">
                          Attribute name
                        </th>
                        <th className="sort" data-sort="Attribute_created_at">
                          Date created
                        </th>
                        <th className="sort" data-sort="Attribute_updated_at">
                          Modification date
                        </th>
                    ...
                    <tbody className="list form-check-all">
                      {Attribute.map((row) => (
                        <tr key={row._id}>
                          ...
                          <td className="Attribute_created_at">
                            {row.createDate}
                          </td>
                          <td className="Attribute_updated_at">
                            {row.modifyDate}
                          </td>
                          <td>
                  ...
                  <div className="noresult" style={{ display: "none" }}>
                    <div className="text-center">
                      <lord-icon
                        ...
                        trigger="loop"
                        Attribute="primary:#121331,secondary:#08a88a"
      ...
      <Card>
        ...
        <CardBody>
          ...
          <Select
            ...
            onBlur={props.handleAttributeBlur}
            onChange={(selectedOption) => {
              props.handleAttributeChange(selectedOption);
            }}
          />

          {props.blur && props.errors ? (
            <Alert Attribute="danger">
              <strong>An error occurred!</strong>
              {props.errors}
            </Alert>
          ) : null}
...
export default EcommerceAttributes;
