...
const SearchResults = () => {
  ...
  document.title = "Search Results | Eezer - React Admin & Dashboard Template";
                  ...
                  <TabContent activeTab={activeTab} className="text-muted">
                    <TabPane tabId="1">
                      <div className="pb-3">
                        <h5 className="mb-1">
                          <Link to="#">
                            Eezer - Responsive Bootstrap 5 Admin Dashboard
                          </Link>
                        </h5>
                        <p className="text-success mb-2">
                          https://jeesofttech.com/Eezer/index.html
                        </p>
                        <p className="text-muted mb-2">
                          Eezer admin is super flexible, powerful, clean, modern
                          ...
                          or update design in your existing project using Eezer
                          ...
                          <li className="list-inline-item">
                            <div className="d-flex align-items-center">
                              ...
                              <div className="flex-grow-1 fs-13 ms-1">
                                <span className="fw-medium">jeesofttech</span>
                              </div>
                            </div>
                          </li>
                        </ul>
                      ...
                      <div className="py-3">
                        <h5 className="mb-1">
                          <Link to="#">
                            Skote - Admin & Dashboard Template by jeesofttech
                          </Link>
                        </h5>
                        <p className="text-success mb-2">
                          https://jeesofttech.com/skote/
                        </p>
                        <p className="text-muted mb-2">
                      ...
                      <div className="py-3">
                        ...
                        <p className="text-success mb-2">
                          https://jeesofttech.com/minia/react/
                        </p>
                        <p className="text-muted mb-2">
                      ...
                      <div className="py-3">
                        ...
                        <p className="text-success mb-2">
                          https://jeesofttech.com/dason/angular/
                        </p>
                        <p className="text-muted mb-2">
