...
export const postFakeProfile = (data) =>
  api.patch(url.POST_EDIT_PROFILE + "/" + data.idx, data);
...
export const updateCategory = (category) =>
  api.patch(url.UPDATE_CATEGORY + "/" + category._id, category);
//brand
...
export const deleteBrand = (brand) =>
  api.delete(url.DELETE_BRAND + "/" + brand);
...
export const deleteColors = (Colors) =>
  api.delete(url.DELETE_Color + "/" + Colors);
...
export const getProductById = (productId) =>
  api.getById(url.GET_PRODUCT_BY_ID + "/" + productId);
...
export const getOrderById = (orderId) =>
  api.getById(url.GET_ORDER_BY_ID + "/" + orderId);

// add Order
export const addNewOrder = (order) => api.create(url.ADD_NEW_ORDER, order);
// update Order
export const updateOrder = (order) =>
  api.patch(url.UPDATE_ORDER + "/" + order._id, order);
...
export const addNewCustomer = (customer) =>
  api.create(url.ADD_NEW_CUSTOMERS, customer);

// update Customers
export const updateCustomer = (customer) =>
  api.patch(url.UPDATE_CUSTOMERS + "/" + customer._id, customer);

// delete Customers
export const deleteCustomer = (customer) =>
  api.delete(url.DELETE_CUSTOMERS + "/" + customer);
...
export const updateTask = (task) =>
  api.patch(url.UPDATE_TASK + "/" + task._id, task);
...
export const updateContact = (contact) =>
  api.patch(url.UPDATE_CONTACT + "/" + contact._id, contact);
...
export const updateCompanies = (company) =>
  api.patch(url.UPDATE_COMPANIES + "/" + company._id, company);
...
export const updateLead = (lead) =>
  api.patch(url.UPDATE_LEAD + "/" + lead._id, lead);
...
export const updateInvoice = (invoice) =>
  api.patch(url.UPDATE_INVOICE + "/" + invoice._id, invoice);
...
export const updateTicket = (ticket) =>
  api.patch(url.UPDATE_TICKET + "/" + ticket._id, ticket);
