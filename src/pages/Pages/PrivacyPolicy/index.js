...
const PrivacyPolicy = () => {
  document.title = "Privacy Policy | Eezer - React Admin & Dashboard Template";
  return (
    <Col xl={4}>
      <Card>
        ...
        <CardBody className="p-4">
          <div className="d-flex">
            ...
            <div className="flex-grow-1">
              <h5>Quyền Quản Lý</h5>
              <p className="text-muted">Xem thống kê.</p>
              <p className="text-muted">
                Quản lý sản phẩm. Thêm, xóa, sửa, xem chi tiết sản phẩm.
              </p>
              <p className="text-muted">
                Quản lý đơn hàng. Thêm, xóa, sửa, xem chi tiết đơn hàng, xuất
                hóa đơn.
              </p>
              <p className="text-muted">
    ...
    //       </div>
    //       <div className="flex-grow-1">
    //         <h5>Privacy Policy for Eezer</h5>
    //         <p className="text-muted">
