...
const VectorMaps = () => {
  document.title = "Vector Maps | Eezer - React Admin & Dashboard Template";
  return (
    <React.Fragment>
              ...
              <Card>
                ...
                <CardBody>
                  <div id="usa-vectormap" style={{ height: "350px" }}>
                    <Vector value="us_aea" width="724" color="#687cfe" />
                  </div>
                </CardBody>
              </Card>
            </Col>
              ...
              <Card>
                ...
                <CardBody>
                  <div id="canada-vectormap" style={{ height: "350px" }}>
                    <Vector value="ca_lcc" width="500" color="#0ac7fb" />
                  </div>
                </CardBody>
              </Card>
            </Col>
              ...
              <Card>
                ...
                <CardBody>
                  <div id="russia-vectormap">
                    <Vector value="ru_mill" width="500" color="#3cd188" />
                  </div>
                </CardBody>
              </Card>
            </Col>
              ...
              <Card>
                ...
                <CardBody>
                  <div id="spain-vectormap">
                    <Vector value="es_mill" width="500" color="#ff7f5d" />
                  </div>
                </CardBody>
              </Card>
            </Col>
