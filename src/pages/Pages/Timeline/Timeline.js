...
const Timeline = () => {
  ...
  document.title = "Timeline | Eezer - React Admin & Dashboard Template";
                ...
                <div className="timeline">
                  ...
                  <div className="timeline-item left">
                    ...
                    <div className="content">
                      ...
                      <p className="text-muted">
                        Every team project can have a Eezer. Use the Eezer to
                  ...
                  <div className="timeline-item left">
                    ...
                    <div className="content">
                      <h5>Eezer admin dashboard templates layout upload</h5>
                      <p className="text-muted">
                  ...
                  <div className="timeline-continue">
                    ...
                    <Row className="timeline-right">
                      ...
                      <Col xs={12}>
                        <div className="timeline-box">
                          <div className="timeline-text">
                            <h5>Eezer - Project Discussion</h5>
                            <p className="text-muted mb-0">
