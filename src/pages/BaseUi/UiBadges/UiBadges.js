...
const UiBadges = () => {
  document.title = "Badges | Eezer - React Admin & Dashboard Template";
  return (
    <React.Fragment>
      <UiContent />
          ...
          <Row>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>bg--subtle</code> class with the
                ...
                <CardBody>
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      ...
                      <span className="badge border border-light text-body text-body">
                        Light
                      </span>
                    </div>
                  </div>
          ...
          <Row>
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>rounded-pill bg--subtl</code> class with the
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    <code>bg-color-subtle</code> with below mentioned modifier
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      ...
                      <span className="badge bg-light-subtle text-bodybadge-border text-body">
                        Light
                      </span>
                    </div>
                  </div>
                ...
                <CardBody>
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      ...
                      <span className="badge rounded-pill border border-light text-body text-body">
                        Light
                      </span>
                    </div>
                  </div>
