...
const EcommerceAttributes = (props) => {
    ...
    const addColor = async () => {
        ...
        await dispatch(onAddNewColor(newColor));
        setName("");
        setCode("");
    ...
    const ColorOptions = Object.values(Colors).map((row) => ({
        label: row.name,
        value: row._id,
    }));
            ...
            <Card>
                ...
                <CardBody>
                    ...
                    <Select
                        ...
                        value={props.ColorId}
                        onBlur={props.handleColorBlur}
                        onChange={(selectedOption) => {
                            props.handleColorChange(selectedOption);
                        }}
                    />
