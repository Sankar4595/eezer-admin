...
const CoverSignUp = () => {
  document.title = "Cover SignUp | Eezer - React Admin & Dashboard Template";
                      ...
                      <div className="p-lg-5 p-4">
                        <div>
                          ...
                          <p className="text-muted">
                            Get your Free Eezer account now.
                          </p>
                        </div>
                          ...
                          >
                            ...
                            <div className="mb-4">
                              <p className="mb-0 fs-12 text-muted fst-italic">
                                By registering you agree to the Eezer{" "}
                                <Link
                                  to="#"
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="text-center">
                  <p className="mb-0">
                    {new Date().getFullYear()} Eezer. Crafted with{" "}
                    <i className="mdi mdi-heart text-danger"></i> by jeesofttech
                  </p>
                </div>
              </div>
            </div>
